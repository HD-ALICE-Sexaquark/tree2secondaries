...
std::pair<Seed, Seed> FastPCAs_XY(const View::Rec::Track& q1, const View::Rec::Track& q2, double bz, Cache* cache = nullptr);
...
inline std::tuple<Seed, Seed, Cache> FastCorrectPCAs(const View::Rec::Track& q1, const View::Rec::Track& q2, double bz) {
    Cache cache;
