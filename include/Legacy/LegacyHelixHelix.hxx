...
inline std::tuple<Seeder::Seed, Seeder::Seed, Seeder::Deriv, Seeder::Deriv> FullPCAs(const View::Rec::Track& q1, const View::Rec::Track& q2,
                                                                                     double mass1, double mass2, double bz) {

    Particle p1 = Particle::FromTrack(q1, mass1);
    Particle p2 = Particle::FromTrack(q2, mass2);

    double dS[2]{};
    double dsdr[4][6]{};
    GetDStoParticleBz(bz, p1, p2, dS, dsdr);
