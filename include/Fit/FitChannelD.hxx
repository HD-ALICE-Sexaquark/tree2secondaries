...
struct alignas(T2S_SIMD_ALIGN) ChannelD : Fit::Sexaquark {
    ...
    // cuts //
    [[nodiscard]] std::optional<double> DCA_btw_V0_Kaon() const { return GetDCA(0, 1); }
    [[nodiscard]] std::optional<double> DCA_V0_wrt_SV() const { return GetDCA(0); }
    [[nodiscard]] std::optional<double> DCA_Kaon_wrt_SV() const { return GetDCA(1); }
