...
struct alignas(T2S_SIMD_ALIGN) FlatChannelA {
    ...
    void CreateBranches(TTree* t, bool is_mc) {
        ...
        v0a.CreateBranches(t, "V0A");
        v0b.CreateBranches(t, "V0B");
        v0a_pca_sv.CreateBranches(t, "V0A_PCAwrtSV");
        v0b_pca_sv.CreateBranches(t, "V0B_PCAwrtSV");
    }
    ...
    Schema::FlatV0 v0a{};
    Schema::FlatV0 v0b{};
    Schema::State6 v0a_pca_sv{};
    Schema::State6 v0b_pca_sv{};
};

struct alignas(T2S_SIMD_ALIGN) FlatMcChannelA {
