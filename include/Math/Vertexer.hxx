...
inline Particle::State MinimizeDistanceHelixVertex(const Charged& q, const ROOT::Math::XYZPoint& v, const Helper::Propagator& prop) {
...
inline Particle::Pair MinimizeDistanceHelixLine(const Charged& q, const Neutral& n, const Helper::Propagator& prop) {
...
inline Particle::State MinimizeDistanceLineVertex(const Neutral& n, const ROOT::Math::XYZPoint& v, const Helper::Propagator& prop) {
...
inline Particle::Pair MinimizeDistanceLineLine(const Neutral& n, const Neutral& m, const Helper::Propagator& prop) {
    ...
    ROOT::Math::XYZVector dr{n.DecayVertex() - m.DecayVertex()};
